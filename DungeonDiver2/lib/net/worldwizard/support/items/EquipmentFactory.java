...
public class EquipmentFactory {
    ...
    // Methods
    public static Equipment createOneHandedWeapon(final int material, final int weaponType) {
	final Equipment e = new Equipment(
		WeaponMaterialConstants.MATERIAL_COMMON_NAMES[material] + " " + WeaponConstants.WEAPON_1H[weaponType],
	...
	final Equipment e = new Equipment(WeaponMaterialConstants.MATERIAL_COMMON_NAMES[material] + " Claws", 0, 0,
		EquipmentCategoryConstants.EQUIPMENT_CATEGORY_ONE_HANDED_WEAPON, material);
	e.setFirstSlotUsed(EquipmentSlotConstants.SLOT_MAINHAND);
	e.setSecondSlotUsed(EquipmentSlotConstants.SLOT_OFFHAND);
	e.setConditionalSlot(true);
	e.setPotency(material + WeaponMaterialConstants.MATERIALS_POWER_OFFSET);
    ...
    public static Equipment createTwoHandedWeapon(final int material, final int weaponType) {
	final Equipment e = new Equipment(
		WeaponMaterialConstants.MATERIAL_COMMON_NAMES[material] + " " + WeaponConstants.WEAPON_2H[weaponType],
	...
	final Equipment e = new Equipment(
		ArmorMaterialConstants.MATERIAL_COMMON_NAMES[material] + " " + ArmorConstants.ARMOR[armorType], 0, 0,
	...
	final Socks s = new Socks(names[actionType - 1], price, actionType, 1);
	return s;
    }
	...
	for (int x = 0; x < res.length; x++) {
	    res[x] = WeaponMaterialConstants.MATERIAL_COMMON_NAMES[x] + " " + WeaponConstants.WEAPON_1H[weaponType];
	}
	return res;
    }
	...
	final String[] res = new String[WeaponMaterialConstants.MATERIALS_COUNT];
	for (int x = 0; x < res.length; x++) {
	    res[x] = WeaponMaterialConstants.MATERIAL_COMMON_NAMES[x] + " " + WeaponConstants.WEAPON_2H[weaponType];
	}
	return res;
    }
	...
	for (int x = 0; x < res.length; x++) {
	    res[x] = ArmorMaterialConstants.MATERIAL_COMMON_NAMES[x] + " " + ArmorConstants.ARMOR[armorType];
	}
	return res;
    }
