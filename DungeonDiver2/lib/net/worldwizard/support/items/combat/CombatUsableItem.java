...
public class CombatUsableItem extends Item {
    ...
    // Constructors
    public CombatUsableItem(final String itemName, final int itemBuyPrice, final BattleTarget itemTarget) {
	super(itemName, 1, 0);
    ...
    public static CombatUsableItem read(final XDataReader dr) throws IOException {
	final Item i = Item.read(dr);
	final BattleTarget bt = BattleTarget.valueOf(dr.readString());
	final CombatUsableItem cui = new CombatUsableItem(i.getName(), i.getBuyPrice(), bt);
