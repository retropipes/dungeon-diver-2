...
public abstract class MapObject implements TypeConstants, RandomGenerationRule {
     ...
     * @return
     */
    public GameScript getMoveFailedScript(final boolean ie, final int dirX, final int dirY, final int dirZ) {
	final GameScript scpt = new GameScript();
	final GameScriptEntry act0 = new GameScriptEntry();
	act0.setActionCode(GameActionCode.SOUND);
	...
	return MapObjectImageManager.getImage(this.getGameImageName(), this.getBattleName(), this.tt);
    }
    ...
    public final void writeMapObjectX(final XDataWriter writer) throws IOException {
    ...
    public final MapObject readMapObjectX(final XDataReader reader, final String ident, final int ver)
	    throws IOException {
