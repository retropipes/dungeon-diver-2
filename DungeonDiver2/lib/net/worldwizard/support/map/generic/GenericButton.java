...
public abstract class GenericButton extends MapObject {
    ...
    // Constructors
    protected GenericButton(final GenericToggleWall off, final GenericToggleWall on, final TemplateTransform tt) {
	super(false);
	this.offState = off;
	this.onState = on;
	...
	act2.addActionArg(new GameScriptEntryArgument(GameSounds.BUTTON));
