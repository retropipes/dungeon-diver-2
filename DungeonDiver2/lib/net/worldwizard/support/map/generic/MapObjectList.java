...
public class MapObjectList {
    // Fields
    private final MapObject[] allObjects = { new Empty(), new Grass(), new Dirt(), new Sand(), new Snow(), new Tundra(),
	    new Tile(), new Ice(), new Water(), new HotRock(), new Slime(), new Lava(), new Player(), new Wall(),
	    ...
	    new WhiteButton(), new YellowButton(), new CyanButton(), new Teleport(), new EmptyVoid(), new DarkGem(),
	    new LightGem(), new ArmorShop(), new Bank(), new Healer(), new ItemShop(), new Regenerator(),
	    new SocksShop(), new SpellShop(), new WeaponsShop(), new Springboard(), new Pit(), new StairsInto(),
	    new StairsOut() };
	...
	for (int x = 0; x < this.allObjects.length; x++) {
	    allAppearances[x] = ImageTransformer.getTransformedImage(this.allObjects[x].getGameImageName(),
		    this.allObjects[x].getName(), this.allObjects[x].getTemplateTransform());
	}
