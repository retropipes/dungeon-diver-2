...
public class Element {
	...
	if (FaithConstants.getFaithDarkEye(f.getFaithID())) {
	...
	final int prime = 31;
	int result = 1;
	result = prime * result + (this.faith == null ? 0 : this.faith.hashCode());
	...
	result = prime * result + (int) (temp ^ temp >>> 32);
	result = prime * result + (this.transformedEye == null ? 0 : this.transformedEye.hashCode());
	return result;
    }
	...
	if (Double.doubleToLongBits(this.transformBlue) != Double.doubleToLongBits(other.transformBlue)) {
	    return false;
	}
	if (Double.doubleToLongBits(this.transformGreen) != Double.doubleToLongBits(other.transformGreen)) {
	    return false;
	}
	if (Double.doubleToLongBits(this.transformRed) != Double.doubleToLongBits(other.transformRed)) {
	    return false;
	}
	if (this.transformedEye == null) {
	    if (other.transformedEye != null) {
		return false;
	    }
	} else if (!this.transformedEye.equals(other.transformedEye)) {
	    return false;
	}
	return true;
    }
