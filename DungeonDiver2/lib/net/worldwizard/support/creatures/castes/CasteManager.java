...
public class CasteManager implements CasteConstants {
	...
	dialogResult = CommonDialogs.showInputDialog("Select a Caste", "Create Character", names, names[0]);
	...
	if (!CasteManager.CACHE_CREATED) {
		...
		CasteManager.CACHE[x] = CasteLoader.loadCaste(Caste.casteIDtoFilename(casteID));
	    }
