...
public class CharacterLoader {
	...
	final String[] registeredNames = CharacterRegistration.getCharacterList();
	...
	final File characterFile = new File(
		basePath + File.separator + name + Extension.getCharacterExtensionWithPeriod());
