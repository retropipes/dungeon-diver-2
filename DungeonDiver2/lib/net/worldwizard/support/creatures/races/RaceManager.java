...
public class RaceManager {
	...
	dialogResult = CommonDialogs.showInputDialog("Select a Race", "Create Character", names, names[0]);
	...
	if (!RaceManager.CACHE_CREATED) {
		...
		RaceManager.CACHE[x] = RaceLoader.loadRace(Race.raceIDtoFilename(raceID));
	    }
