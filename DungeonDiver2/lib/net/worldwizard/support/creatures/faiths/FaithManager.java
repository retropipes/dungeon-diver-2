...
public class FaithManager {
	...
	dialogResult = CommonDialogs.showInputDialog("Select a Faith", "Create Character", names, names[0]);
	...
	final int faithID = new RandomRange(0, FaithManager.CACHE.length - 1).generate();
	return FaithManager.CACHE[faithID];
    }
}
