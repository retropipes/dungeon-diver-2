...
public class DrainEffect extends Effect {
	...
	this.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_MP, MPReduction, factor, scaleStat);
	...
	if (target.isAlive()) {
	    target.drain((int) this.getEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_MP));
	}
    }
}
