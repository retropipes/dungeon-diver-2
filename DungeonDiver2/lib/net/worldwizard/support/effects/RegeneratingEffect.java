...
public class RegeneratingEffect extends Effect {
	...
	this.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_MP, MPAddition, factor, scaleStat);
	...
	if (target.isAlive()) {
	    target.regenerate((int) this.getEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_MP));
	}
    }
}
