...
public class HealingEffect extends Effect {
	...
	this.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP, HPAddition, factor, scaleStat);
	...
	if (target.isAlive()) {
	    target.heal((int) this.getEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP));
	}
    }
}
