...
public class DamageEffect extends Effect {
	...
	this.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP, HPReduction, factor, scaleStat);
	...
	if (target.isAlive()) {
	    ...
	    final double dmgmult = target.getFaith().getMultiplierForOtherFaith(srcfid);
	    final double damage = this.getEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP) * dmgmult;
