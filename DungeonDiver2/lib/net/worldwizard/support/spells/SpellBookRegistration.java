...
public class SpellBookRegistration {
	...
	final ArrayList<String> registeredNames = SpellBookRegistration.readSpellBookRegistry();
	...
	// Load spellBook list
	final String[] rawSpellBookList = SpellBookRegistration.getRawSpellBookList();
	final String[] systemSpellBookList = SystemRegistration.getRawSystemObjectList("SpellBook", "spellBooks");
	if (rawSpellBookList != null || systemSpellBookList != null) {
		...
		if (systemSpellBookList != null) {
			...
			if (rawSpellBookList != null) {
			    mergedRawList[x] = rawSpellBookList[x - systemSpellBookList.length];
			} else {
			    // Shouldn't ever get here
			    return null;
			}
	...
	// Load spell book list
	final String[] spellBookIDList = SpellBookRegistration.getSpellBookIDList();
	final String[] spellBookNameList = SpellBookRegistration.getSpellBookNameList();
	...
	try (final FileInputStream fis = new FileInputStream(
		basePath + File.separator + "SpellBookRegistry" + Extension.getRegistryExtensionWithPeriod());
