...
public class GameScriptEntryArgument {
    ...
    public static GameScriptEntryArgument read(final XDataReader reader) throws IOException {
	...
	result = prime * result + (this.strArg == null ? 0 : this.strArg.hashCode());
	...
	if (Double.doubleToLongBits(this.decArg) != Double.doubleToLongBits(other.decArg)) {
	    return false;
	}
