...
public class GameScriptConstants {
    ...
    public static final Class<?>[] ARGT_MOVE = new Class[] { boolean.class, boolean.class, int.class, int.class,
	    int.class };
    public static final Class<?>[] ARGT_END_GAME = null;
    public static final Class<?>[] ARGT_MODIFY = new Class[] { boolean.class, int.class, int.class, int.class,
    ...
    public static final Class<?>[] ARGT_SWAP_PAIRS = new Class[] { String.class, String.class };
    ...
    public static final int[] ARGUMENT_COUNT_VALIDATION = new int[] { GameScriptConstants.ARGC_NONE,
	    GameScriptConstants.ARGC_MESSAGE, GameScriptConstants.ARGC_SOUND, GameScriptConstants.ARGC_SHOP,
	    GameScriptConstants.ARGC_MOVE, GameScriptConstants.ARGC_END_GAME, GameScriptConstants.ARGC_MODIFY,
	    GameScriptConstants.ARGC_DELETE_SCRIPT, GameScriptConstants.ARGC_RANDOM_CHANCE,
	    GameScriptConstants.ARGC_BATTLE, GameScriptConstants.ARGC_DECAY, GameScriptConstants.ARGC_REDRAW,
	    GameScriptConstants.ARGC_LEVEL_CHANGE, GameScriptConstants.ARGC_SWAP_PAIRS,
	    GameScriptConstants.ARGC_ADD_TO_SCORE, GameScriptConstants.ARGC_RELATIVE_LEVEL_CHANGE };
    // Argument Type Validation Array
    public static final Class<?>[][] ARGUMENT_TYPE_VALIDATION = new Class[][] { GameScriptConstants.ARGT_NONE,
	    GameScriptConstants.ARGT_MESSAGE, GameScriptConstants.ARGT_SOUND, GameScriptConstants.ARGT_SHOP,
	    GameScriptConstants.ARGT_MOVE, GameScriptConstants.ARGT_END_GAME, GameScriptConstants.ARGT_MODIFY,
	    GameScriptConstants.ARGT_DELETE_SCRIPT, GameScriptConstants.ARGT_RANDOM_CHANCE,
	    GameScriptConstants.ARGT_BATTLE, GameScriptConstants.ARGT_DECAY, GameScriptConstants.ARGT_REDRAW,
	    GameScriptConstants.ARGT_LEVEL_CHANGE, GameScriptConstants.ARGT_SWAP_PAIRS,
	    GameScriptConstants.ARGT_ADD_TO_SCORE, GameScriptConstants.ARGT_RELATIVE_LEVEL_CHANGE };
