...
public class GameScript {
	...
	if (!this.tempActions.isEmpty()) {
	    ...
	    final GameScriptEntry[] acts = this.tempActions.toArray(new GameScriptEntry[this.tempActions.size()]);
	    this.actions = acts;
	...
	result = prime * result + (this.tempActions == null ? 0 : this.tempActions.hashCode());
	return result;
    }
