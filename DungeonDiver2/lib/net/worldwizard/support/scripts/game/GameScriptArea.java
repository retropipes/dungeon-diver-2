...
public class GameScriptArea extends GameScript {
    ...
    public static GameScriptArea read(final XDataReader reader) throws IOException {
	...
	final int prime = 31;
	int result = 1;
	result = prime * result + (this.lowerRight == null ? 0 : this.lowerRight.hashCode());
	result = prime * result + (this.name == null ? 0 : this.name.hashCode());
	result = prime * result + (this.upperLeft == null ? 0 : this.upperLeft.hashCode());
	return result;
    }
