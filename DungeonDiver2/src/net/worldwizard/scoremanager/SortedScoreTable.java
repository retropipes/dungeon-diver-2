...
public class SortedScoreTable extends ScoreTable {
    ...
    public static SortedScoreTable readSortedScoreTableXML(final XDataReader xdr) throws IOException {
	...
	for (int x = 0; x < len; x++) {
	    sst.table[x] = Score.readScoreXML(xdr);
	}
	return sst;
    }

    public void writeSortedScoreTableXML(final XDataWriter xdw) throws IOException {
