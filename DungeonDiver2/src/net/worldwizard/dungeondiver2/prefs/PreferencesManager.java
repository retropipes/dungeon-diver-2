...
public class PreferencesManager {
	...
	DungeonDiver2.getApplication().getVariablesManager().getMap().setGeneratorRandomness(value, 6);
    }

    public static int getBattleSpeed() {
	return BattleSpeedConstants.BATTLE_SPEED_ARRAY[PreferencesManager.storeMgr.getInteger("BattleSpeed",
		BattleSpeedConstants.BATTLE_SPEED_MODERATE)];
    }

    static int getBattleSpeedValue() {
	return PreferencesManager.storeMgr.getInteger("BattleSpeed", BattleSpeedConstants.BATTLE_SPEED_MODERATE);
    }
