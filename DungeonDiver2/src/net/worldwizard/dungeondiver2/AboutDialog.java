...
public class AboutDialog implements AboutHandler {
	...
	this.textPane.add(new JLabel("Web Site: http://dungeondiver2.worldwizard.net/"));
	this.textPane.add(new JLabel("E-mail bug reports to: dungeondiver2@worldwizard.net  "));
