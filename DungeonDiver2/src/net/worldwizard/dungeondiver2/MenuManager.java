...
public class MenuManager {
    ...
    private JMenuItem fileOpen, fileClose, fileSave, fileSaveAs, filePrint, filePreferences, fileExit;
    private JMenuItem gamePlay, gameEquipment, gameItemInventory, gameShowScore, gamePickLeader, gameRegisterCharacter,
	    gameUnregisterCharacter;
    private JMenuItem battleItem, battleSpell, battleSteal, battleDrain, battleEndTurn;
    private JMenuItem aiRegister, aiUnregister, aiImport;
    private JMenuItem helpAbout, helpObjectHelp;
    private KeyStroke fileOpenAccel, fileCloseAccel, fileSaveAccel, fileSaveAsAccel, filePrintAccel,
	    filePreferencesAccel;
    private KeyStroke gamePlayMapAccel;
    private KeyStroke battleItemAccel, battleSpellAccel, battleStealAccel, battleDrainAccel, battleEndTurnAccel;
	...
	this.gamePlayMapAccel = KeyStroke.getKeyStroke(KeyEvent.VK_P, modKey | InputEvent.SHIFT_DOWN_MASK);
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (cmd.equals("Open...")) {
		    ...
		    final PartyMember pm = PartyManager.getParty().pickOnePartyMember();
		    if (pm != null) {
