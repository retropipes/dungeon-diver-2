...
class BattleStats {
	...
	final BufferedImageIcon nameImage = StatImageManager.getStatImage("name");
	this.nameLabel.setIcon(nameImage);
	final BufferedImageIcon teamImage = StatImageManager.getStatImage("team");
	this.teamLabel.setIcon(teamImage);
	final BufferedImageIcon hpImage = StatImageManager.getStatImage("health");
	this.hpLabel.setIcon(hpImage);
	final BufferedImageIcon mpImage = StatImageManager.getStatImage("magic");
	this.mpLabel.setIcon(mpImage);
	final BufferedImageIcon attImage = StatImageManager.getStatImage("attack");
	this.attLabel.setIcon(attImage);
	final BufferedImageIcon defImage = StatImageManager.getStatImage("defense");
	this.defLabel.setIcon(defImage);
	final BufferedImageIcon apImage = StatImageManager.getStatImage("actions");
	this.apLabel.setIcon(apImage);
	this.attLeftLabel.setIcon(attImage);
	final BufferedImageIcon spImage = StatImageManager.getStatImage("spells");
